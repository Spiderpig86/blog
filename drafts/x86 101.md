...
What this does is create the **stack frame** which in essence places all the parameters, the return address, and the function itself in the right order on the **stack** so it can execute and return to the caller.
...
6. [6](http://www.unixwiz.net/techtips/x86-jumps.html)
7. [7](https://en.wikipedia.org/wiki/FLAGS_register)